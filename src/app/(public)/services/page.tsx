...
const SERVICES = [
  ...
  { id: 'mantra_writing', icon: 'edit_note', label: 'Likhit Japa (Mantra Lekhnan)', price: 199, badge: 'NEW', desc: 'Nakshatra-specific written mantra practice with precise 4-step protocol — personalized Vishnu Sahasranama shloka for your pada.', features: ['Universal Ganpati mantra', 'Gayatri mantra', 'Nakshatra Ganpati', 'Vishnu Sahasranama shloka', 'Pada-specific guidance'] },

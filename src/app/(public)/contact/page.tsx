    ...
    <div className="min-h-screen">
      ...
      <section className="page-banner">
        <div className="page-banner-inner max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4" style={{ fontFamily: "var(--font-display)" }}>Contact Us</h1>
          <div className="ornate-divider">
            <Icon name="yantra" size={16} className="text-[var(--gold-300)]" />
          </div>
          <p className="text-[var(--text-on-dark-secondary)] text-lg">We are here to guide you on your spiritual journey</p>
        </div>
      </section>
      ...
      <section className="py-14 px-6 bg-[var(--kutch-white)]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="card-divine p-6">
                <div className="w-12 h-12 rounded-2xl bg-emerald-50 flex items-center justify-center mb-4">
                  <Icon name="call" size={24} className="text-emerald-600" />
                </div>
                <p className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-widest mb-1">Phone / WhatsApp</p>
                <p className="text-xl font-bold text-[var(--indigo-deep)] mb-1">+91 92748 15269</p>
                <p className="text-sm font-semibold text-[var(--text-secondary)] mb-1">+91 98587 84784</p>
                <p className="text-xs text-[var(--text-muted)] mb-4">Mon - Sat · 10 AM - 7 PM IST</p>
              ...
              <div className="card-divine p-6">
                ...
                <p className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-widest mb-1">Email</p>
                <p className="text-base font-bold text-[var(--indigo-deep)] mb-1 break-all">info@mahatathastu.com</p>
                <p className="text-xs text-[var(--text-muted)] mb-4">We respond within 24 hours</p>
            ...
            {/* Social Media */}
            <div className="card-divine p-6">
              <h2 className="text-lg font-bold text-[var(--indigo-deep)] mb-4" style={{ fontFamily: "var(--font-display)" }}>Follow Us</h2>
            ...
            {/* Quick links */}
            <div className="card-divine p-6">
              <h2 className="text-lg font-bold text-[var(--indigo-deep)] mb-4" style={{ fontFamily: "var(--font-display)" }}>Quick Actions</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <Link key={item.href} href={item.href}
                    ...
                    <span className="text-sm font-semibold text-[var(--text-secondary)] group-hover:text-[var(--indigo-deep)] transition-colors">{item.label}</span>
                    <Icon name="arrow_forward" size={16} className="text-[var(--text-muted)] group-hover:text-[var(--indigo-deep)] ml-auto transition-colors" />
                  </Link>
                ))}
              </div>
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="card-divine p-6">
              <div className="flex items-center gap-2 mb-4">
                <Icon name="schedule" size={20} className="text-[var(--saffron)]" />
                <h2 className="text-base font-bold text-[var(--indigo-deep)]" style={{ fontFamily: "var(--font-display)" }}>Business Hours</h2>
              </div>
            ...
            <div className="card-divine p-6">
              <div className="flex items-center gap-2 mb-4">
                <Icon name="location_on" size={20} className="text-[var(--terracotta)]" />
                <h2 className="text-base font-bold text-[var(--indigo-deep)]" style={{ fontFamily: "var(--font-display)" }}>Address</h2>
              </div>
              <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                FF-108, SIDDHARTH MAGNUM PLUS<br />
                TARSALI, VADODARA, GUJARAT<br />
                <span className="text-xs text-[var(--text-muted)] mt-1 block">Visits by prior appointment only</span>
              </p>
              <a href="https://wa.me/919274815269?text=I%20would%20like%20to%20schedule%20an%20appointment"
                ...
                style={{ background: '#25D366' }}>
                <Icon name="chat" size={14} /> Schedule Appointment
              </a>
            </div>

            {/* About us snippet */}
            <div className="rounded-2xl p-6 text-center" style={{ background: 'linear-gradient(135deg, var(--indigo-deep) 0%, var(--plum) 100%)' }}>
              <p className="text-[var(--text-on-dark)] text-sm leading-relaxed font-medium" style={{ fontFamily: "var(--font-display)" }}>
                "India's first comprehensive holistic life platform - combining Vedic wisdom with modern guidance."
              </p>
              <Link href="/about" className="mt-4 inline-flex items-center gap-1 text-xs text-[var(--text-on-dark-secondary)] hover:text-white transition-colors">
                Learn more about us <Icon name="arrow_forward" size={14} />
              </Link>
            </div>
          </div>
        </div>

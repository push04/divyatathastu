...
const GANESH_ATTRIBUTES = [
  { sanskrit: 'à¤µà¤¿à¤˜à¥à¤¨à¤¹à¤°à¥à¤¤à¤¾', english: 'Vighnaharta', meaning: 'Remover of all obstacles from life, business, and relationships' },
  { sanskrit: 'à¤¬à¥à¤¦à¥à¤§à¤¿à¤ªà¥à¤°à¤¦', english: 'Buddhiprada', meaning: 'Bestower of intelligence, clarity, and right decision-making' },
  { sanskrit: 'à¤¸à¤¿à¤¦à¥à¤§à¤¿à¤¦à¤¾à¤¤à¤¾', english: 'Siddhidaata', meaning: 'Giver of success and accomplishment in all endeavors' },
  { sanskrit: 'à¤®à¤‚à¤—à¤²à¤®à¥‚à¤°à¥à¤¤à¤¿', english: 'Mangalmurti', meaning: 'Auspicious form that blesses new beginnings and ventures' },
]

const PUJA_BENEFITS = [
  { icon: 'ðŸš€', title: 'New Beginnings', desc: 'Start any venture â€” business, marriage, home, education â€” under Ganesh\'s divine protection.' },
  { icon: 'ðŸ”“', title: 'Remove Blockages', desc: 'Dissolve obstacles in career, finances, relationships, and spiritual progress.' },
  { icon: 'ðŸ“š', title: 'Enhanced Learning', desc: 'Students receive Ganesh\'s special blessings for clarity, retention, and exam success.' },
  { icon: 'ðŸ’¼', title: 'Business Prosperity', desc: 'Invite Riddhi (wealth) and Siddhi (success) â€” Ganesh\'s consorts â€” into your ventures.' },
  { icon: 'ðŸ ', title: 'Vastu Harmony', desc: 'Ganesh puja in the northeast (Ishaan corner) of your home amplifies positive Vastu energy.' },
  { icon: 'ðŸ™', title: 'Spiritual Progress', desc: 'As the first deity worshipped in all Hindu rituals, Ganesh opens the path to higher realms.' },
]
...
export default function MahaganpatiPage() {
  ...
  async function bookService(item: typeof items[number]) {
    ...
    const { error } = await (supabase as any).from('service_bookings').insert({
      ...
      notes: `Puja: ${item.title}${preferred[item.id] ? ` â€” Preferred date: ${preferred[item.id]}` : ''}`,
    })
    ...
    <div className="min-h-screen bg-[var(--kutch-white)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-[#9a3412] mb-5" style={{ fontFamily: "'Playfair Display', serif" }}>
                à¤µà¤•à¥à¤°à¤¤à¥à¤£à¥à¤¡ à¤®à¤¹à¤¾à¤•à¤¾à¤¯ à¤¸à¥‚à¤°à¥à¤¯à¤•à¥‹à¤Ÿà¤¿ à¤¸à¤®à¤ªà¥à¤°à¤­
              </p>
              <p className="text-sm text-[#7c2d12]/70 mb-8 leading-relaxed">
                Invoke the blessings of Mahaganpati â€” the supreme form of Lord Ganesha â€” through authentic Vedic puja performed by trained priests. Remove every obstacle from your path and invite divine grace into your life, business, and home.
              </p>
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="w-56 h-56 rounded-full flex items-center justify-center shadow-2xl text-8xl"
                  style={{ background: 'linear-gradient(135deg, #fed7aa, #fdba74, #fb923c)', border: '4px solid rgba(234,88,12,0.3)' }}>
                  ðŸ˜
                </div>
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 text-center">
                  <p className="text-lg font-black text-[#9a3412]" style={{ fontFamily: "'Playfair Display', serif" }}>à¥ à¤—à¤‚ à¤—à¤£à¤ªà¤¤à¤¯à¥‡ à¤¨à¤®à¤ƒ</p>
                </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-16">
            ...
            {GANESH_ATTRIBUTES.map(a => (
              <div key={a.english} className="bento-card p-5 flex gap-4 items-start">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)', border: '1px solid rgba(234,88,12,0.2)' }}>
                  <span className="text-[#9a3412] font-black text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>à¥</span>
                </div>
                <div>
                ...
                <div key={item.id} className="bento-card p-6 flex flex-col hover:shadow-lg transition-all hover:-translate-y-0.5">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex gap-1.5 flex-wrap">
                      {item.is_live && <span className="text-[10px] px-2 py-0.5 rounded-full bg-orange-100 text-orange-700 font-semibold">ðŸ”´ Live</span>}
        ...
        <section className="text-center py-10 rounded-2xl" style={{ background: 'linear-gradient(135deg, #fff7ed, #ffedd5)', border: '2px solid rgba(234,88,12,0.2)' }}>
          ...
          <h2 className="text-2xl font-bold text-[#431407] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>Chaturthi â€” The Auspicious Day</h2>

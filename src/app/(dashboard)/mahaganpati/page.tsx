...
const PUJA_BENEFITS = [
  { icon: '🚀', title: 'New Beginnings', desc: 'Start any venture — business, marriage, home, education — under Ganesh\'s divine protection.' },
  { icon: '🔓', title: 'Remove Blockages', desc: 'Dissolve obstacles in career, finances, relationships, and spiritual progress.' },
  { icon: '📚', title: 'Enhanced Learning', desc: 'Students receive Ganesh\'s special blessings for clarity, retention, and exam success.' },
  { icon: '💼', title: 'Business Prosperity', desc: 'Invite Riddhi (wealth) and Siddhi (success) — Ganesh\'s consorts — into your ventures.' },
  { icon: '🏠', title: 'Vastu Harmony', desc: 'Ganesh puja in the northeast (Ishaan corner) of your home amplifies positive Vastu energy.' },
  { icon: '🙏', title: 'Spiritual Progress', desc: 'As the first deity worshipped in all Hindu rituals, Ganesh opens the path to higher realms.' },
]

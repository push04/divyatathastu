...
// â”€â”€ NOTE: Font.register() is intentionally NOT here. â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const C = {
  ...
  // accent â€” max 2 uses per page; contrast: 8:1 on bgPage
  vermillion:    '#7A1212',
...
const styles = StyleSheet.create({
  ...
  body: { fontSize: 9, fontFamily: 'Helvetica', color: C.charcoal, lineHeight: 1.6 },
  bodySmall: { fontSize: 8, fontFamily: 'Helvetica', color: C.text, lineHeight: 1.55 },
  bodyMuted: { fontSize: 8, fontFamily: 'Helvetica', color: C.gray, lineHeight: 1.5 },
  italic: { fontSize: 8.5, fontFamily: 'Helvetica-Oblique', color: C.gray, lineHeight: 1.5 },
  bullet: { fontSize: 9, fontFamily: 'Helvetica', color: C.textDark, lineHeight: 1.6, marginBottom: 2 },
  ...
  td: { fontSize: 8, fontFamily: 'Helvetica', color: C.text },
...
// â”€â”€ Sudarshan Chakra (site logo) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Ornament divider â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Diamond corner marks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Corner lotus ornaments (4 orientations, no CSS transform) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Gold concentric circles watermark on navy sections â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Interior page border â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function PageBorder() {
  return (
    <>
...
// â”€â”€ Very faint chakra watermark â€” bottom-right, not overlapping content â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Mandala SVG for cover page header â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function MandalaHeaderSVG({ size = 120 }: { size?: number }) {
  ...
  // 8 lotus petals â€” teardrop from inner r=44 to outer r=58
...
// â”€â”€ Diamond transition strip (full page width) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Diamond divider for interior pages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ L-shaped corner ornaments for framed blocks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Three-column page footer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function PageFooter() {
  return (
    <View style={{ position: 'absolute', bottom: 14, left: 32, right: 32 }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
        <Text style={{ fontSize: 7, fontFamily: 'Helvetica', color: C.textMeta, letterSpacing: 0.3 }}>www.mahatathastu.com</Text>
        <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: C.navy, letterSpacing: 1.5 }}>MAHATATHASTU</Text>
        <Text style={{ fontSize: 7, fontFamily: 'Helvetica', color: C.textMeta, letterSpacing: 0.3 }}>9858784784</Text>
      </View>
    </View>
  )
}

// â”€â”€ Chapter header â€” wax seal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <View style={{ marginBottom: 10 }}>
      ...
      <View style={{ backgroundColor: C.navy, padding: '11pt 15pt', flexDirection: 'row', alignItems: 'center' }}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 16, fontFamily: 'Helvetica-Bold', color: C.white, letterSpacing: 0.5 }}>{title}</Text>
          {sanskrit ? <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: C.goldLight, marginTop: 2, letterSpacing: 1 }}>{sanskrit}</Text> : null}
        </View>
        <View style={{ opacity: 0.85 }}>
          <Text style={{ fontSize: 20, fontFamily: 'Helvetica-Bold', color: C.gold }}>OM</Text>
        </View>
      </View>
...
// â”€â”€ Title header (non-chapter pages) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <View style={{ marginBottom: 12 }}>
      ...
      <View style={{ backgroundColor: C.navy, padding: '10pt 15pt', alignItems: 'center' }}>
        <Text style={{ fontSize: 17, fontFamily: 'Helvetica-Bold', color: C.white, letterSpacing: 1.5 }}>{title}</Text>
        {subtitle ? <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: C.goldLight, marginTop: 3, letterSpacing: 1 }}>{subtitle}</Text> : null}
      </View>
      <View style={{ height: 2, backgroundColor: C.gold }} />
    </View>
  )
...
// â”€â”€ InfoGrid â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ BulletList â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ TagRow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ HighlightBox â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Two-column info box â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function CoverPage({ report, member, title }: { report: any; member: any; title: string }) {
  ...
  return (
    <Page size="A4" style={{ backgroundColor: C.bgPage, fontFamily: 'Helvetica', flexDirection: 'column', position: 'relative' }}>
      ...
      {/* â”€â”€ ZONE 1: TOP HEADER BAND (navy, ~210pt tall) â”€â”€ */}
      <View style={{ backgroundColor: C.bgDark, paddingTop: 16, paddingBottom: 16, paddingHorizontal: 44, alignItems: 'center', position: 'relative' }}>
        ...
        {/* Sanskrit invocations â€” side by side with separator */}
        <View style={{ flexDirection: 'row', alignItems: 'center', zIndex: 1, marginBottom: 10, opacity: 0.7 }}>
          <Text style={{ fontSize: 7, fontFamily: 'Helvetica', color: C.textOnDark, letterSpacing: 1.8 }}>
            SHREE MATRA NAMAH
          </Text>
        ...
        {/* Brand name */}
        <Text style={{ fontSize: 32, fontFamily: 'Helvetica-Bold', color: C.goldOnDark, letterSpacing: 5, marginTop: 8, zIndex: 1 }}>
          MAHATATHASTU
        </Text>
        ...
        <View style={{ opacity: 0.65, marginTop: 6 }}>
          <Text style={{ fontSize: 6.5, fontFamily: 'Helvetica', color: C.textOnDark, letterSpacing: 2 }}>
            DECODE YOUR LIFE  Â·  DESIGN YOUR FUTURE
          </Text>
        </View>
      </View>

      {/* â”€â”€ ZONE 2: DECORATIVE DIAMOND TRANSITION STRIP â”€â”€ */}
      <DiamondTransitionStrip />
      <View style={{ height: 1, backgroundColor: C.borderStrong }} />

      {/* â”€â”€ ZONE 3: CREAM BODY â”€â”€ */}
      <View style={{ flex: 1, backgroundColor: C.bgPage, paddingHorizontal: 44, paddingTop: 26, paddingBottom: 60, position: 'relative' }}>
        ...
        {/* Person name */}
        {member?.full_name ? (
          <Text style={{ fontSize: 32, fontFamily: 'Helvetica-Bold', color: C.textPrimary, letterSpacing: 2, lineHeight: 1.2 }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
          {dob ? (
            <Text style={{ fontSize: 10.5, fontFamily: 'Helvetica', color: C.textSecondary, letterSpacing: 0.3 }}>{dob}</Text>
          ) : null}
          {dob && member?.place_of_birth ? (
            <Text style={{ fontSize: 14, color: C.goldBright, marginHorizontal: 8, lineHeight: 1 }}>Â·</Text>
          ) : null}
          {member?.place_of_birth ? (
            <Text style={{ fontSize: 10.5, fontFamily: 'Helvetica', color: C.textSecondary, letterSpacing: 0.3 }}>{member.place_of_birth}</Text>
          ) : null}
        </View>
        <Text style={{ fontSize: 8.5, fontFamily: 'Helvetica', color: C.textMeta, letterSpacing: 0.3 }}>
          Report Generated: {gen}
        </Text>

        {/* â”€â”€ Lineage Block â€” framed with corner ornaments â”€â”€ */}
        <View style={{ marginTop: 28, border: `1pt solid ${C.borderSubtle}`, paddingHorizontal: 28, paddingVertical: 18, position: 'relative' }}>
          ...
          <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Bold', color: C.goldOnCream, letterSpacing: 2, textAlign: 'center', marginBottom: 8 }}>
            LINEAGE & TRADITION
          </Text>
          <View style={{ width: 48, height: 0.5, backgroundColor: C.borderSubtle, alignSelf: 'center', marginBottom: 10 }} />
          <Text style={{ fontSize: 11, fontFamily: 'Helvetica-Oblique', color: C.textSecondary, textAlign: 'center', lineHeight: 1.7, marginBottom: 6 }}>
            Lineage of Maharishi Bhrigu  Â·  Tradition of Vasishtha
          </Text>
          <Text style={{ fontSize: 9, fontFamily: 'Helvetica', color: C.textMeta, textAlign: 'center', letterSpacing: 0.5, lineHeight: 1.6 }}>
            Surya Â· Pitamaha Â· Vyasa Â· Vasishtha Â· Atri Â· Parashara Â· Kashyapa
          </Text>
        </View>

        {/* â”€â”€ Institution credit â”€â”€ */}
        <View style={{ marginTop: 18, alignItems: 'center' }}>
          <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Bold', color: C.goldOnCream, letterSpacing: 2, marginBottom: 4 }}>
            AN INITIATIVE OF ANUSHTHAAN INDIA
          </Text>
          <Text style={{ fontSize: 10, fontFamily: 'Helvetica-Oblique', color: C.textMeta }}>
            GYANAMEETHAM Â· Educating Society with Wisdom for a Better Life
          </Text>
        </View>
      </View>

      {/* â”€â”€ FOOTER BAR (absolute, 44pt) â”€â”€ */}
      <View style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 44, backgroundColor: C.bgDark, borderTop: `2pt solid ${C.goldBright}`, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 44, justifyContent: 'space-between' }}>
        <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: C.goldOnDark, letterSpacing: 1.8 }}>MAHATATHASTU</Text>
        <View style={{ opacity: 0.8 }}><Text style={{ fontSize: 8, fontFamily: 'Helvetica', color: C.textOnDark }}>www.mahatathastu.com</Text></View>
        <View style={{ opacity: 0.8 }}><Text style={{ fontSize: 8, fontFamily: 'Helvetica', color: C.textOnDark }}>9858784784</Text></View>
      </View>
...
// â”€â”€ GUIDANCE PAGE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function GuidancePage() {
  const cards = [
    ...
    },
    {
      ...
      body: 'For purification and correction of karmic energies, practice the remedies continuously for a minimum of 90 days without interruption. Karmic patterns take time to shift â€” consistency is the key that unlocks transformation.',
    },
    {
      num: '03',
      title: 'Daily Consistency',
      body: 'Performing remedies at the same time each day â€” especially during sunrise or the prescribed muhurta â€” amplifies their effectiveness significantly. The cosmic energies are most receptive at fixed daily intervals.',
    },
    {
      num: '04',
      title: 'Sattvic Lifestyle & Inner Sincerity',
      body: 'Maintain a sattvic diet, avoid intoxicants, speak truthfully, and practice charitable acts during the remedy period. Approach every mantra, ritual, and remedy as a direct conversation with the divine â€” external actions without inner sincerity yield limited results.',
    },
  ]
  ...
  return (
    <Page size="A4" style={{ backgroundColor: C.bgPage, fontFamily: 'Helvetica', flexDirection: 'column', position: 'relative' }}>
      ...
      {/* â”€â”€ PAGE HEADER â€” navy, 80pt â”€â”€ */}
      <View style={{ backgroundColor: C.bgDark, paddingTop: 16, paddingBottom: 18, paddingHorizontal: 44, position: 'relative' }}>
        ...
        <View style={{ opacity: 0.6 }}>
          <Text style={{ fontSize: 8, fontFamily: 'Helvetica', color: C.textOnDark, letterSpacing: 2.5 }}>
            MAHATATHASTU Â· ANUSHTHAAN INDIA
          </Text>
        </View>
        <Text style={{ fontSize: 26, fontFamily: 'Helvetica-BoldOblique', color: C.goldOnDark, letterSpacing: 1.5, marginTop: 4, zIndex: 1 }}>
          Divine Guidance
        </Text>
        <View style={{ opacity: 0.7, marginTop: 3 }}>
          <Text style={{ fontSize: 9, fontFamily: 'Helvetica', color: C.textOnDark }}>
            How to use this Report
          </Text>
        </View>
      </View>

      {/* â”€â”€ Thin gold rule â”€â”€ */}
      ...
      <View style={{ flex: 1, paddingHorizontal: 44, paddingTop: 22, paddingBottom: 70 }}>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 14 }}>
          ...
          <View style={{ width: 36, height: 36, backgroundColor: C.bgDark, alignItems: 'center', justifyContent: 'center', marginRight: 8, marginTop: 2 }}>
            <Text style={{ fontSize: 26, fontFamily: 'Helvetica-Bold', color: C.goldOnDark, lineHeight: 1 }}>T</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 10.5, fontFamily: 'Helvetica', color: C.textSecondary, lineHeight: 1.85 }}>
          ...
          {cards.map((card) => (
            <View key={card.num} style={{ flexDirection: 'row', marginBottom: 14, alignItems: 'flex-start' }}>
              ...
              <View style={{ width: 34, height: 34, borderRadius: 17, backgroundColor: C.bgDark, alignItems: 'center', justifyContent: 'center', marginRight: 14, flexShrink: 0 }}>
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: C.goldOnDark, letterSpacing: 0.5 }}>
                  {card.num}
                </Text>
              </View>
              {/* Card body */}
              <View style={{ flex: 1, borderLeft: `2pt solid ${C.borderStrong}`, paddingLeft: 12, paddingVertical: 4 }}>
                <Text style={{ fontSize: 12, fontFamily: 'Helvetica-Bold', color: C.textPrimary, marginBottom: 4, letterSpacing: 0.3 }}>
                  {card.title}
                </Text>
                <Text style={{ fontSize: 9.5, fontFamily: 'Helvetica', color: C.textSecondary, lineHeight: 1.75 }}>
                  {card.body}
                </Text>
              </View>
            </View>
        ...
        <View style={{ backgroundColor: C.bgCard, borderTop: `2pt solid ${C.borderStrong}`, borderBottom: `2pt solid ${C.borderStrong}`, paddingVertical: 16, paddingHorizontal: 24, alignItems: 'center' }}>
          <Text style={{ fontSize: 20, fontFamily: 'Helvetica-BoldOblique', color: C.vermillion, letterSpacing: 2, marginBottom: 6 }}>
            Om Tat Sat
          </Text>
          <Text style={{ fontSize: 10, fontFamily: 'Helvetica', color: C.textSecondary, textAlign: 'center', lineHeight: 1.8 }}>
            May this report illuminate your path to self-knowledge, purpose, and dharmic living.
          </Text>
          <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: C.goldOnCream, textAlign: 'center', marginTop: 8, letterSpacing: 1 }}>
            â€” MahaTathastu Team Â· Anushthaan India
          </Text>
        </View>
...
// â”€â”€ KUNDLI SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function KundliPages({ data, canvasImg, number }: { data: any; canvasImg?: string; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Kundli & Birth Chart" sanskrit="Graha Jyotisha â€” Vedic Astrology" />
      ...
      <InfoGrid items={[
        ...
        { label: 'Ayanamsa', value: k.ayanamsa ? `Lahiri ${Number(k.ayanamsa).toFixed(4)}Â°` : undefined },
          ...
          <View style={styles.table}>
            ...
            {k.planets.map((p: any, i: number) => (
              <View key={p.name} style={i % 2 === 0 ? styles.tableRow : styles.tableRowAlt}>
                ...
                <Text style={[styles.td, { flex: 1 }]}>{p.degree != null ? `${Number(p.degree).toFixed(1)}Â°` : '-'}</Text>
      ...
      {analysis ? (
        <View style={{ marginTop: 8 }}>
          ...
          {analysis.currentPhase ? <HighlightBox label="Current Dasha Phase â€” What to Expect" text={analysis.currentPhase} accent={C.navy} /> : null}
...
// â”€â”€ NUMEROLOGY SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function NumerologyPages({ data, canvasImg, number }: { data: any; canvasImg?: string; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Numerology Analysis" sanskrit="Anka Shastra â€” Science of Numbers" />
      ...
      {n.interpretation?.lifePath ? (
        <HighlightBox
          label={`Life Path ${n.lifePathNumber}${n.interpretation.lifePathTitle ? ` â€” ${n.interpretation.lifePathTitle}` : ''}`}
      ...
      {n.interpretation?.soulUrge ? <HighlightBox label={`Soul Urge ${n.soulUrgeNumber} â€” Inner Motivation`} text={n.interpretation.soulUrge} accent={C.navyMid} /> : null}
      ...
      {n.interpretation?.personalYear ? (
        <HighlightBox label={`Personal Year ${n.personalYearNumber} â€” Annual Cycle`} text={n.interpretation.personalYear} accent={C.saffron} />
      ) : null}
      {n.interpretation?.maturity ? <HighlightBox label={`Maturity Number ${n.maturityNumber} â€” Life Purpose After 35`} text={n.interpretation.maturity} accent={C.emerald} /> : null}
      {n.interpretation?.hiddenPassion ? <HighlightBox label="Hidden Passion â€” Deepest Talent" text={n.interpretation.hiddenPassion} accent={C.gold} /> : null}
...
// â”€â”€ CHAKRA SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function ChakraPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Shakti Chakra Analysis" sanskrit="Chakra Vigyan â€” Energy Body Science" />
        ...
        return (
          <View key={i} style={{ marginBottom: 10, borderLeft: `4pt solid ${color}`, paddingLeft: 9, paddingTop: 6, paddingBottom: 6, backgroundColor: C.offWhite }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 3 }}>
              <Text style={[styles.h3, { flex: 1, marginBottom: 0, color }]}>{c.name}{c.sanskrit ? ` â€” ${c.sanskrit}` : ''}</Text>
              <Text style={[styles.label, { color: color, marginBottom: 0 }]}>{c.status?.toUpperCase() || ''} Â· {lvl}%</Text>
            </View>
...
// â”€â”€ PRAKRITI SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function PrakritiPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Prakriti â€” Ayurvedic Constitution" sanskrit="Prakriti Vigyan â€” Ayurveda" />
...
// â”€â”€ YANTRA SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function YantraPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Yantra & Colour Therapy" sanskrit="Yantra Shastra â€” Sacred Geometry" />
...
// â”€â”€ MANTRA SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function MantraPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Mantra Guidance" sanskrit="Mantra Sadhana â€” Sacred Sound Practice" />
      ...
      {wr ? (
        <View style={{ marginTop: ch ? 10 : 0 }}>
          <SectionLabel>Likhit Japa â€” Sacred Writing Practice</SectionLabel>
          <InfoGrid cols={2} items={[
...
// â”€â”€ PSYCHOLOGY SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function PsychologyPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Vedic Psychology" sanskrit="Manas Vigyan â€” Mind Science" />

      <View style={[styles.cardBlue, { marginBottom: 10 }]}>
        <Text style={[styles.label, { color: C.goldLight, marginBottom: 3 }]}>Moon Archetype â€” Your Psychological Type</Text>
        <Text style={{ fontSize: 20, fontFamily: 'Helvetica-Bold', color: C.white }}>{ps.moonPersonalityType}</Text>
        {ps.moonArchetypeTagline ? <Text style={{ fontSize: 8.5, fontFamily: 'Helvetica-Oblique', color: C.goldLight, marginTop: 3 }}>{ps.moonArchetypeTagline}</Text> : null}
      </View>
      ...
      {ps.growthEdge ? <HighlightBox label="Growth Edge â€” Your Highest Potential" text={ps.growthEdge} accent={C.saffron} /> : null}
...
// â”€â”€ DMIT SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function DmitPages({ data, canvasImg, number }: { data: any; canvasImg?: string; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="DMIT Intelligence Profile" sanskrit="Dermatoglyphics â€” Fingerprint Analysis" />
...
// â”€â”€ COLOUR THERAPY SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function ColourTherapyPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Colour Therapy" sanskrit="Ranga Chikitsa â€” Chromotherapy" />
      ...
      {ct.powerColor ? (
        <View style={[styles.cardBlue, { marginBottom: 8 }]}>
          ...
          <Text style={{ fontSize: 18, fontFamily: 'Helvetica-Bold', color: C.white }}>{ct.powerColor}</Text>
...
// â”€â”€ ANNUAL PREDICTION SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function AnnualPredictionPages({ data, number }: { data: any; number: string }) {
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Annual Prediction" sanskrit="Varshik Bhavisyavani â€” Yearly Forecast" />
...
// â”€â”€ REMEDIES SECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function RemediesPages({ data, number }: { data: any; number: string }) {
        ...
        {arr.map((item: any, i: number) => {
          ...
          return (
            <View key={i} style={[styles.card, { marginBottom: 4 }]}>
              ...
              {item.day ? <Text style={styles.bodySmall}>Day: {item.day}  {item.time ? `Â· Time: ${item.time}` : ''}</Text> : null}
  ...
  return (
    <Page size="A4" style={styles.page} wrap>
      <PageBorder />
      <PageWatermark />
      <ChapterHeader number={number} title="Remedies & Upaya" sanskrit="Upaya Shastra â€” Vedic Remediation" />
...
// â”€â”€ DISCLAIMER PAGE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function DisclaimerPage() {
  const items = [
    ...
    { title: 'Astronomical Accuracy', body: 'Planetary positions are calculated using the NASA-grade astronomy-engine library with Lahiri ayanamsa (the official standard of the Government of India). Accuracy is within Â±0.001 degrees.' },
    { title: 'Free Will & Destiny', body: 'Vedic astrology recognizes that the birth chart shows tendencies and potential â€” not fixed destiny. Human free will, conscious effort, and spiritual practice can always transform outcomes.' },
  ]
  ...
  return (
    <Page size="A4" style={styles.page}>
      ...
      <View style={[styles.highlightGold, { alignItems: 'center' }]}>
        <Text style={{ fontSize: 18, fontFamily: 'Helvetica-BoldOblique', color: C.crimson, textAlign: 'center', marginBottom: 5 }}>Om Tat Sat</Text>
        ...
        <Text style={[styles.bodySmall, { textAlign: 'center', color: C.navy, marginTop: 5, fontFamily: 'Helvetica-Bold' }]}>
          â€” MahaTathastu Â· Anushthaan India
        </Text>
